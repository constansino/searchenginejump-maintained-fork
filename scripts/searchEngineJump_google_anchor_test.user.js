// ==UserScript==
// @name           searchEngineJump 搜索引擎快捷跳转（Google定位测试版）
// @author         NLF&锐经(修改) & iqxin(修改)
// @contributor    iqxin
// @description    基于5.26.7的测试副本：优化Google结果页挂载位置，减少滚动后消失问题
// @version        5.26.7-gfix2
// @created        2011-07-02
// @lastUpdated    2024-12-22

// @namespace      https://local.test/searchenginejump-google-anchor-test
...
// @downloadURL https://local.test/searchenginejump-google-anchor-test.user.js
// @updateURL https://local.test/searchenginejump-google-anchor-test.meta.js
// ==/UserScript==
